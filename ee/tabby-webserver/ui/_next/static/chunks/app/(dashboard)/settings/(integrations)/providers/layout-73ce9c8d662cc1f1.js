(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [6807],
    {
        98641: function (n, e, t) {
            ...
            let i = (n) => ("boolean" == typeof n ? "".concat(n) : 0 === n ? "0" : n),
                a = function () {
                ...
                r = (n, e) => (t) => {
                    var r;
                    if ((null == e ? void 0 : e.variants) == null) return a(n, null == t ? void 0 : t.class, null == t ? void 0 : t.className);
                    let { variants: s, defaultVariants: o } = e,
                        d = Object.keys(s).map((n) => {
                            let e = null == t ? void 0 : t[n],
                                a = null == o ? void 0 : o[n];
                        ...
                        u =
                            t &&
                            Object.entries(t).reduce((n, e) => {
                                let [t, i] = e;
                                return void 0 === i || (n[t] = i), n;
                            }, {}),
                        c =
                            null == e
                                ? void 0
                                : null === (r = e.compoundVariants) || void 0 === r
                                    ? void 0
                                    : r.reduce((n, e) => {
                                        let { class: t, className: i, ...a } = e;
                                        return Object.entries(a).every((n) => {
                                            let [e, t] = n;
                                            return Array.isArray(t) ? t.includes({ ...o, ...u }[e]) : { ...o, ...u }[e] === t;
                                        })
                                            ? [...n, t, i]
                                            : n;
                                    }, []);
                    return a(n, d, c, null == t ? void 0 : t.class, null == t ? void 0 : t.className);
                };
        },
        99656: function (n, e, t) {
            Promise.resolve().then(t.bind(t, 69145)), Promise.resolve().then(t.bind(t, 57830));
        },
        69145: function (n, e, t) {
            "use strict";
            t.r(e),
                t.d(e, {
                    default: function () {
            ...
            var i = t(36164),
                ...
                m = t(90155),
                g = t(11529);
            let p = (0, d.j)("flex items-center gap-1 rounded-lg px-3 py-2 transition-all hover:bg-accent", { variants: { state: { selected: "bg-accent", "not-selected": "" } }, defaultVariants: { state: "not-selected" } });
            function f(n) {
                let { className: e } = n,
                    [t] = (0, l.Hb)(),
                    [a] = (0, m.useShowLicenseBanner)();
                return (0, i.jsxs)("div", {
                    className: (0, u.cn)("sticky top-16 space-y-1 overflow-y-auto border-r pr-4 text-sm font-medium", e),
                    style: t || a ? { height: "calc(100vh - ".concat(t && a ? "7rem" : "3.5rem", " - 4rem)") } : { height: "calc(100vh - 4rem)" },
                    children: [
                        (0, i.jsx)(h, { href: "/settings/providers/git", children: "Git" }),
                        g.K.map((n) => (0, i.jsx)(h, { href: "/settings/providers/".concat(n.name), children: n.meta.displayName }, n.name)),
                        (0, i.jsxs)(h, {
                            href: "/settings/providers/doc",
                            children: ["Developer Docs", (0, i.jsx)(c.C, { variant: "outline", className: "h-3.5 border-secondary-foreground/60 px-1.5 text-[10px] text-secondary-foreground/60", children: "Beta" })],
                        }),
                    ],
                });
            }
            function h(n) {
                let { href: e, children: t } = n,
                    r = (0, o.usePathname)(),
                    d = a.useMemo(() => {
                        var n;
                        let t = "/settings/providers/doc";
                        if (null == r ? void 0 : r.startsWith(t)) return e.startsWith(t);
                        let i = null === (n = r.match(/^(\/settings\/providers\/[\w-]+)/)) || void 0 === n ? void 0 : n[1];
                        return i === e;
                    }, [r, e]);
                return (0, i.jsx)(s(), { className: p({ state: d ? "selected" : "not-selected" }), href: e, children: t });
            }
        },
        11529: function (n, e, t) {
            ...
            var i = t(18500);
            let a = [
                { name: "github", enum: i.q6.Github, meta: { displayName: "GitHub" } },
                { name: "github-self-hosted", enum: i.q6.GithubSelfHosted, meta: { displayName: "GitHub Self-Hosted" } },
                { name: "gitlab", enum: i.q6.Gitlab, meta: { displayName: "GitLab" } },
                { name: "gitlab-self-hosted", enum: i.q6.GitlabSelfHosted, meta: { displayName: "GitLab Self-Hosted" } },
            ];
        },
        30601: function (n, e, t) {
            "use strict";
            t.d(e, {
                Hb: function () {
                    return g;
            ...
            let c = "3.5rem",
                ...
                m = (n) => {
                    ...
                    return (
                        ...
                        (0, i.jsx)(l.Provider, { value: { isShowDemoBanner: s, setIsShowDemoBanner: d }, children: e })
                    );
                };
            function g() {
                let { isShowDemoBanner: n, setIsShowDemoBanner: e } = a.useContext(l);
                return [n, e];
            }
            function p() {
                let [n, e] = g(),
                    { data: t } = (0, s.Z)("https://api.github.com/repos/TabbyML/tabby", (n) => fetch(n).then((n) => n.json()));
                return (0, i.jsxs)("div", {
                    className: (0, d.cn)("flex items-center justify-between bg-primary px-4 text-primary-foreground transition-[opacity,height] md:px-5", { "opacity-100 pointer-events-auto": n, "opacity-0 pointer-events-none": !n }),
                    style: n ? { height: c } : { height: 0 },
                    children: [
                        (0, i.jsxs)("a", {
                            ...
                            children: [(0, i.jsx)("span", { children: "\uD83D\uDCC6" }), (0, i.jsx)("span", { children: "Book a 30-minute product demo." })],
                        }),
                        n && (0, i.jsx)("img", { referrerPolicy: "no-referrer-when-downgrade", src: "https://static.scarf.sh/a.png?x-pxid=b1d0308a-b3c5-425a-972a-378d883a2bca" }),
                        (0, i.jsxs)("div", {
                            ...
                            children: [
                                (0, i.jsxs)("a", {
                                    ...
                                    children: [
                                        (0, i.jsx)(u.IconGithub, {}),
                                        (0, i.jsxs)("div", {
                                            className: "ml-2 hidden md:block",
                                            children: [
                                                (0, i.jsx)("p", { className: "text-xs font-semibold", children: "TabbyML/tabby" }),
                                                (0, i.jsxs)("div", {
                                                    className: (0, d.cn)("flex items-center text-xs transition-all", { "h-4 opacity-70": t, "h-0 opacity-0": !t }),
                                                    children: [
                                                        (0, i.jsx)(u.IconStar, { className: "mr-1 h-2.5 w-2.5" }),
                                                        (0, i.jsx)("span", { children: null == t ? void 0 : t.stargazers_count }),
                                                        (0, i.jsx)(u.IconGitFork, { className: "ml-2 mr-1 h-2.5 w-2.5" }),
                                                        (0, i.jsx)("span", { children: null == t ? void 0 : t.forks_count }),
                                                    ],
                                                }),
                                            ],
                                        }),
                                ...
                                (0, i.jsx)(u.IconClose, { className: "cursor-pointer transition-all hover:opacity-70", onClick: () => e(!1) }),
                            ],
                        }),
                    ],
                });
        ...
        90155: function (n, e, t) {
            ...
            let m = "3.5rem",
                ...
                p = (n) => {
                    let { children: e } = n,
                        { isExpired: t, isSeatsExceeded: r, isLicenseOK: s } = (0, d.Cz)(),
                        [o, u] = a.useState(!1);
                    return (
                        a.useEffect(() => {
                            let n = window.self !== window.top;
                        ...
                        (0, i.jsx)(g.Provider, { value: { isShowLicenseBanner: o, setIsShowLicenseBanner: u }, children: e })
                    );
                };
            function f() {
                let { isShowLicenseBanner: n, setIsShowLicenseBanner: e } = a.useContext(g);
                return [n, e];
            }
            function h() {
                let [n, e] = f(),
                    { isExpired: t, isSeatsExceeded: r } = (0, d.Cz)(),
                    g = (0, o.usePathname)(),
                    p = (0, a.useMemo)(() => (t ? "Your subscription is expired." : r ? "You have more active users than seats included in your subscription." : "No valid license configured"), [t, r]);
                return (0, i.jsxs)("div", {
                    className: (0, u.cn)("flex items-center justify-between bg-secondary px-4 text-secondary-foreground transition-[height,opacity] md:px-5", {
                        "opacity-100 pointer-events-auto border-b": n,
                        "opacity-0 pointer-events-none": !n,
                    }),
                    style: n ? { height: m } : { height: 0 },
                    children: [
                        (0, i.jsxs)("div", { className: "flex items-center gap-1 font-semibold text-destructive", children: [(0, i.jsx)(c.IconNotice, {}), p] }),
                        (0, i.jsxs)("div", {
                            className: "flex items-center gap-x-4 md:gap-x-8",
                            children: [
                                "/settings/subscription" !== g && (0, i.jsx)(s(), { href: "/settings/subscription", className: (0, u.cn)((0, l.d)(), "gap-1"), children: "See more" }),
                                (0, i.jsx)(c.IconClose, { className: "cursor-pointer transition-all hover:opacity-70", onClick: () => e(!1) }),
                            ],
                        }),
                    ],
                });
        ...
        63795: function (n, e, t) {
            ...
            var a = t(98641),
                r = t(73492);
            let s = (0, a.j)("inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2", {
                variants: {
                    variant: {
            ...
            function o(n) {
                let { className: e, variant: t, ...a } = n;
                return (0, i.jsx)("div", { className: (0, r.cn)(s({ variant: t }), e), ...a });
            }
        },
        31458: function (n, e, t) {
            "use strict";
            t.d(e, {
                d: function () {
                    return d;
            ...
            let d = (0,
                ...
                u = a.forwardRef((n, e) => {
                    let { className: t, variant: a, size: s, asChild: u = !1, ...c } = n,
                        l = u ? r.g7 : "button";
                    return (0, i.jsx)(l, { className: (0, o.cn)(d({ variant: a, size: s, className: t })), ref: e, ...c });
                });
            u.displayName = "Button";
        },
        57830: function (n, e, t) {
            "use strict";
            t.r(e),
                t.d(e, {
                    ScrollArea: function () {
            ...
            var i = t(36164),
                ...
                r = t(86102),
                s = t(73492);
            let o = a.forwardRef((n, e) => {
                let { className: t, children: a, ...o } = n;
                return (0, i.jsxs)(r.fC, {
                    className: (0, s.cn)("relative overflow-hidden", t),
                    ...o,
                    children: [(0, i.jsx)(r.l_, { ref: e, className: "h-full w-full rounded-[inherit] [&>div]:!block", children: a }), (0, i.jsx)(d, {}), (0, i.jsx)(r.Ns, {})],
                });
            });
            o.displayName = r.fC.displayName;
            let d = a.forwardRef((n, e) => {
                let { className: t, orientation: a = "vertical", ...o } = n;
                return (0, i.jsx)(r.gb, {
                    ref: e,
                    orientation: a,
                    className: (0, s.cn)(
                        "flex touch-none select-none transition-colors",
                        "vertical" === a && "h-full w-2.5 border-l border-l-transparent p-[1px]",
                        "horizontal" === a && "h-2.5 flex-col border-t border-t-transparent p-[1px]",
                        t
                    ),
                    ...o,
                    children: (0, i.jsx)(r.q4, { className: "relative flex-1 rounded-full bg-border" }),
                });
            });
            d.displayName = r.gb.displayName;
        },
        75561: function (n, e, t) {
            "use strict";
            t.d(e, {
                B: function () {
                    return r;
            ...
            function r(n) {
                var e;
                return null !== (e = a[n]) && void 0 !== e ? e : {};
            }
        },
        43240: function (n, e, t) {
            "use strict";
            t.d(e, {
                BX: function () {
                    return i.B;
        ...
        29917: function (n, e, t) {
            ...
            let o = (0, r.BX)("\n  query GetLicenseInfo {\n    license {\n      type\n      status\n      seats\n      seatsUsed\n      issuedAt\n      expiresAt\n    }\n  }\n"),
                ...
                u = () => {
                    let [{ data: n }] = d();
                    return null == n ? void 0 : n.license;
                },
                c = (n) => {
                    var e;
                    let [{ data: t }] = d(),
                        a = null == t ? void 0 : t.license,
                        r = (0, i.useSearchParams)(),
                        o = !!a && (!(null == n ? void 0 : null === (e = n.licenses) || void 0 === e ? void 0 : e.length) || n.licenses.includes(a.type)),
                        u = (null == a ? void 0 : a.status) === s.rW.Ok,
                        c = (null == a ? void 0 : a.status) === s.rW.Expired,
                        l = (null == a ? void 0 : a.status) === (null === s.rW || void 0 === s.rW ? void 0 : s.rW.SeatsExceeded),
                        m = "expired" === r.get("licenseError"),
                        g = "seatsExceed" === r.get("licenseError");
                    return { hasLicense: !!a, isLicenseOK: u && !(m || g), isExpired: c || m, isSeatsExceeded: l || g, hasSufficientLicense: o };
                };
        },
        80605: function (n, e, t) {
            "use strict";
            t.d(e, {
                UA: function () {
                    return m;
            ...
            let r = (0, a.BX)("\n  query GetServerInfo {\n    serverInfo {\n      isAdminInitialized\n      isEmailConfigured\n      isChatEnabled\n      allowSelfSignup\n      isDemoMode\n      disablePasswordLogin\n    }\n  }\n"),
                s = () => {
                    let [{ data: n }] = (0, i.aM)({ query: r });
                    return null == n ? void 0 : n.serverInfo;
                },
                o = () => {
                    let [{ fetching: n }] = (0, i.aM)({ query: r });
                    return n;
                },
                d = () => {
                    var n;
                    return null === (n = s()) || void 0 === n ? void 0 : n.isChatEnabled;
                },
                u = () => {
                    var n;
                    return null === (n = s()) || void 0 === n ? void 0 : n.isAdminInitialized;
                },
                c = () => {
                    var n;
                    return null === (n = s()) || void 0 === n ? void 0 : n.isEmailConfigured;
                },
                l = () => {
                    var n;
                    return null === (n = s()) || void 0 === n ? void 0 : n.allowSelfSignup;
                },
                m = () => {
                    var n;
                    return null === (n = s()) || void 0 === n ? void 0 : n.isDemoMode;
                },
                g = () => {
                    var n;
                    return null === (n = s()) || void 0 === n ? void 0 : n.disablePasswordLogin;
                };
        },
        11978: function (n, e, t) {
            n.exports = t(77280);
        },
        54491: function (n, e, t) {
            "use strict";
            function i(n, [e, t]) {
        ...
        36327: function (n, e, t) {
            ...
            var i = t(21454),
                a = t(54859);
            let r = (0, a.xD)(i.ZP, (n) => (e, t, i) => ((i.revalidateOnFocus = !1), (i.revalidateIfStale = !1), (i.revalidateOnReconnect = !1), n(e, t, i)));
        },
    },
    function (n) {
        n.O(0, [7565, 8415, 4691, 55, 436, 340, 4007, 1454, 6065, 3492, 1565, 3375, 5289, 1744], function () {
            return n((n.s = 99656));
        }),
            (_N_E = n.O());
    },

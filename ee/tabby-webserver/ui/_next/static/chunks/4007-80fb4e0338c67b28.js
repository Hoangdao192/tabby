    ...
    [4007],
    {
        ...
        54007: function (e, t, n) {
            ...
            function y(e, t, n, r, o, l) {
                ...
                let a = l ? e.prefetch(t, o) : e.prefetch(t, n, r);
            ...
            let _ = o.default.forwardRef(function (e, t) {
                let n, r;
                let { href: a, as: g, children: _, prefetch: P = null, passHref: v, replace: O, shallow: R, scroll: j, locale: E, onClick: S, onMouseEnter: w, onTouchStart: N, legacyBehavior: M = !1, ...x } = e;
                (n = _), M && ("string" == typeof n || "number" == typeof n) && (n = o.default.createElement("a", null, n));
                let C = o.default.useContext(c.RouterContext),
                    k = o.default.useContext(f.AppRouterContext),
                    I = null != C ? C : k,
                    T = !C,
                    L = !1 !== P,
                    U = null === P ? m.PrefetchKind.AUTO : m.PrefetchKind.FULL,
                    { href: A, as: W } = o.default.useMemo(() => {
                        if (!C) {
                            let e = b(a);
                            return { href: e, as: g ? b(g) : e };
                        }
                        let [e, t] = (0, l.resolveHref)(C, a, !0);
                        return { href: e, as: g ? (0, l.resolveHref)(C, g) : t || e };
                    }, [C, a, g]),
                    D = o.default.useRef(A),
                    z = o.default.useRef(W);
                M && (r = o.default.Children.only(n));
                let K = M ? r && "object" == typeof r && r.ref : t,
                    [q, F, $] = (0, d.useIntersection)({ rootMargin: "200px" }),
                ...
                o.default.useEffect(() => {
                    I && F && L && y(I, A, W, { locale: E }, { kind: U }, T);
                ...
                let Y = {
                    ...
                    onClick(e) {
                        M || "function" != typeof S || S(e),
                            ...
                            (function (e, t, n, r, l, a, u, s, c, f) {
                                ...
                                let h = () => {
                                    let e = null == u || u;
                                    "beforePopState" in t ? t[l ? "replace" : "push"](n, r, { shallow: a, locale: s, scroll: e }) : t[l ? "replace" : "push"](r || n, { forceOptimisticNavigation: !f, scroll: e });
                                };
                    ...
                    onMouseEnter(e) {
                        M || "function" != typeof w || w(e),
                            ...
                            I && (L || !T) && y(I, A, W, { locale: E, priority: !0, bypassPrefetchedCheck: !0 }, { kind: U }, T);
                    },
                    onTouchStart(e) {
                ...
                else if (!M || v || ("a" === r.type && !("href" in r.props))) {
                    let e = void 0 !== E ? E : null == C ? void 0 : C.locale,
                        t = (null == C ? void 0 : C.isLocaleDomain) && (0, p.getDomainLocale)(W, e, null == C ? void 0 : C.locales, null == C ? void 0 : C.domainLocales);
                    Y.href = t || (0, h.addBasePath)((0, s.addLocale)(W, e, null == C ? void 0 : C.defaultLocale));
                }
                return M ? o.default.cloneElement(r, Y) : o.default.createElement("a", { ...x, ...Y }, n);
            }),
                P = _;
            ("function" == typeof t.default || ("object" == typeof t.default && null !== t.default)) &&
                void 0 === t.default.__esModule &&
                ...
                try {
                    ...
                    if ((0, s.isDynamicRoute)(e.pathname) && e.searchParams && n) {
                        let n = (0, r.searchParamsToUrlQuery)(e.searchParams),
                            { result: i, params: a } = (0, c.interpolateAs)(e.pathname, e.pathname, n);
                        i && (t = (0, o.formatWithValidation)({ pathname: i, hash: e.hash, query: (0, l.omit)(n, a) }));
                    }
                        ...
                        if (e && e.tagName) {
                            let r = (function (e, t, n) {
                                let { id: r, observer: o, elements: l } = (function (e) {
                                    ...
                                    return (t = { id: n, observer: l, elements: o }), a.push(n), i.set(n, t), t;
                                })(n);
                                return (
                                    l.set(e, t),
                                    o.observe(e),
        ...
        85376: function (e, t, n) {
            ...
            function i(e) {
                ...
                return (
                    r && !r.endsWith(":") && (r += ":"),
                    e.slashes || ((!r || l.test(r)) && !1 !== s) ? ((s = "//" + (s || "")), i && "/" !== i[0] && (i = "/" + i)) : s || (s = ""),
                    a && "#" !== a[0] && (a = "#" + a),
                    c && "?" !== c[0] && (c = "?" + c),
                    "" + r + s + (i = i.replace(/[?#]/g, encodeURIComponent)) + (c = c.replace("#", "%23")) + a
                );
            }
                ...
                return (
                    s.every((e) => {
                        let t = u[e] || "",
                            ...
                            o = "[" + (n ? "..." : "") + e + "]";
                        return r && (o = (t ? "" : "/") + "[" + o + "]"), n && !Array.isArray(t) && (t = [t]), (r || e in u) && (l = l.replace(o, n ? t.map((e) => encodeURIComponent(e)).join("/") : encodeURIComponent(t)) || "/");
                    }) || (l = ""),
                    { params: s, result: l }
                );
            }
                    ...
                    parameterizedRoute: t
                        .map((e) => {
                            let t = r.INTERCEPTION_ROUTE_MARKERS.find((t) => e.startsWith(t)),
                                l = e.match(/\[((?:\[.*\])|.+)\]/);
                            if (t && l) {
                                let { key: e, optional: r, repeat: u } = i(l[1]);
                                return (n[e] = { pos: a++, repeat: u, optional: r }), "/" + (0, o.escapeStringRegexp)(t) + "([^/]+?)";
                            }
                    ...
                    namedParameterizedRoute: i
                        .map((e) => {
                            let n = r.INTERCEPTION_ROUTE_MARKERS.some((t) => e.startsWith(t)),
                                l = e.match(/\[((?:\[.*\])|.+)\]/);
                            return n && l
                                ? s({ getSafeRouteKey: a, segment: l[1], routeKeys: u, keyPrefix: t ? "nxtI" : void 0 })
                                : l
                                    ? s({ getSafeRouteKey: a, segment: l[1], routeKeys: u, keyPrefix: t ? "nxtP" : void 0 })
            ...
            class n {
                ...
                _insert(e, t, r) {
                    ...
                    if (o.startsWith("[") && o.endsWith("]")) {
                        let n = o.slice(1, -1),
                            i = !1;
                        if ((n.startsWith("[") && n.endsWith("]") && ((n = n.slice(1, -1)), (i = !0)), n.startsWith("...") && ((n = n.substring(3)), (r = !0)), n.startsWith("[") || n.endsWith("]")))
